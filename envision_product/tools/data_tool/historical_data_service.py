"""
Historical Data Service for managing and querying historical transportation data.

This service handles loading historical transportation data from CSV files and 
providing search and analysis capabilities for lane-based queries.
"""
import pandas as pd
import numpy as np
import os
...
class HistoricalDataService:
    ...
    def _get_lane_summary(self, filtered_df: pd.DataFrame, request) -> Dict[str, Any]:
        """
    ...
    async def query_historical_data(self, request):
        """
        ...
        Returns:
            The response model containing matching records and statistics.
        """
        # Import here to avoid circular imports
        from .main import HistoricalDataResponse, HistoricalRecord
